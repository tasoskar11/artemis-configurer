 ...
 *       &lt;sequence&gt;
 *         &lt;element name="connector" type="{urn:activemq:core}transportType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
public class Connectors {
    ...
    protected List<TransportType> connector;
     ...
     * 
     */
    public List<TransportType> getConnector() {
        if (connector == null) {
            connector = new ArrayList<TransportType>();
        }
