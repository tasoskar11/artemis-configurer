 ...
 *       &lt;sequence&gt;
 *         &lt;element name="bridge" type="{urn:activemq:core}bridgeType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class Bridges {
    ...
    protected List<BridgeType> bridge;
     ...
     * 
     */
    public List<BridgeType> getBridge() {
        if (bridge == null) {
            bridge = new ArrayList<BridgeType>();
        }
        return this.bridge;
    }
