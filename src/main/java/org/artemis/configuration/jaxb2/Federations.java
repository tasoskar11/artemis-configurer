 ...
 *       &lt;sequence&gt;
 *         &lt;element name="federation" type="{urn:activemq:core}federationType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlRootElement(name = "federations")
public class Federations {

    protected List<FederationType> federation;
     ...
     * 
     */
    public List<FederationType> getFederation() {
        if (federation == null) {
            federation = new ArrayList<FederationType>();
        }
